...
export default function SettingsModal({ open, onClose }: Props) {
  ...
  return (
    <div style={{ position: 'fixed', inset: 0, zIndex: 50, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      ...
      <div style={{ position: 'relative', zIndex: 51, maxWidth: '500px', width: 'calc(100% - 32px)', maxHeight: '80vh', overflow: 'auto', borderRadius: '8px', backgroundColor: '#0f172a', padding: '20px', boxSizing: 'border-box' }}>
