...
def _build_system_prompt(editor_code: str = "") -> str:
    ...
    parts = [
        ...
        "- 用 create_strategy / create_portfolio_strategy / create_cross_factor / create_ml_alpha 工具保存代码",
        ...
        "```",
        "- model_factory 必须返回白名单内的 estimator: Ridge/Lasso/RF/GBR/LGBM/XGB",
