...
app = FastAPI(title="ez-trading", version="0.2.8.1", lifespan=lifespan)
...
from ez.api.routes import market_data, backtest, factors, experiments, candidates, code, chat, settings, research  # noqa: E402
